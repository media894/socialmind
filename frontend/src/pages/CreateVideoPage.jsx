...
${productionNotes}`
    ...
    try {
      ...
      let gr = null
      if (activeGroqKey) {
        const candidateModels = ['llama-3.1-8b-instant', 'llama3-70b-8192', 'llama3-8b-8192', 'mixtral-8x7b-32768', 'gemma2-9b-it']
    ...
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-white/40 text-sm">Press ▶ Play — records automatically · navigates to Review when done</p>
